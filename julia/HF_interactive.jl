...
**Bond Length (Å):** $(@bind bond_length_angstrom Slider(0.5:0.05:2.5, default=0.74, show_value=true))
...
**Implementation:** Julia with BasisSets.jl | **Author:** Keiran Rowell with Claude Sonnet 4.5 prompting of written code
